...
public class LoginService implements BaseService<LoginRequest, ResponseModel<LoginResponse>> {
    ...
    public ResponseModel<LoginResponse> execute(LoginRequest req) {
        ...
        String refreshToken = jwtHelper.generateAppToken(emp.getUsername(), JsonHelper.objectToJsonString(jwtPayload), new ArrayList<>(), customConfigMapProperties.getRefreshTokenExp());
